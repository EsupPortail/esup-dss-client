...
public interface ProductAdapter {
	 ...
	 * @param api The unique instance of {@link EsupDSSClientAPI}.
	 * @param product The target product.
	 * @param callback Password input callback.
	 * @return A label for the given <code>product</code>.
	 */
	String getLabel(EsupDSSClientAPI api, Product product, PasswordInputCallback callback);
	 ...
	 * @return A label for the given <code>product</code>.
	 */
	String getLabel(EsupDSSClientAPI api, Product product, PasswordInputCallback callback, MessageDisplayCallback messageCallback);
	 ...
	 */
	SignatureTokenConnection connect(EsupDSSClientAPI api, Product product, PasswordInputCallback callback);
	 ...
	 */
	FutureOperationInvocation<Product> getConfigurationOperation(EsupDSSClientAPI api, Product product);
	 ...
	 */
	FutureOperationInvocation<Boolean> getSaveOperation(EsupDSSClientAPI api, Product product);
