...
/**
 * Handles creation of configuration folder.
 * 
...
public class ConfigurationManager {
	...
	File manageWindowsConfiguration(String appName) throws IOException {
		...
		/* It is possible that an "old" configuration folder exists on the host. If such configuration folder exists, Esup-DSS-Client copy all the
		 * old configuration files to the new location. 
		 */
		File incorrectConfigFile = findExistingConfigFolder(appName);
		if (incorrectConfigFile != null && incorrectConfigFile.exists()) {
