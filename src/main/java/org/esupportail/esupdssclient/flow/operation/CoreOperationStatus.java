...
import org.esupportail.esupdssclient.api.flow.OperationStatus;

/**
 * This enum defines {@link OperationStatus}es applicable to the core version of Esup-DSS-Client.
 *
 * @author Jean Lepropre (jean.lepropre@nowina.lu)
 */
public enum CoreOperationStatus implements OperationStatus {

	UNSUPPORTED_PRODUCT("unsupported.product", "The provided product is not supported by this version of Esup-DSS-Client."),
	...
	NO_CARD_OR_KEY("no.card.or.key", "No card or certificate key was found."),
