...
#pkgbuild --version 1.2.2.0 --identifier org.esupportail.esup-dss-client --install-location /Applications/esup-dss-client.app --scripts Contents/Scripts --identifier org.esupportail.esup-dss-client --sign "Developer ID Installer: ****" --root . Distribution.pkg
pkgbuild --version 1.2.2.0 --identifier org.esupportail.esup-dss-client --install-location /Applications/esup-dss-client.app --scripts Contents/Scripts --identifier org.esupportail.esup-dss-client --root . Distribution.pkg
